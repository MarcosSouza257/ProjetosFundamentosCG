...
// Titulo do Exercicio
char title_window[] = "Ex. 7. Desenhe uma espiral";
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_LINE_STRIP, 0, numberOfPoints-1);
...
int setupGeometry()
{
	...
	float angle = 45.0;
	float deltaAngle = 5.7 * pi / (float)(numberOfPoints);
	float radius = 0.0;
	float radiusIncrement = 0.5 / (float)(numberOfPoints);
